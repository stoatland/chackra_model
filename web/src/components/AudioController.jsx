...
const AudioController = ({ timerState, isEnabled = true }) => {
    ...
    return (
        <div style={{
            ...
            <h3 style={{ marginTop: 0, color: '#fff' }}>Audio Controls</h3>
                ...
                <>
                    <div style={{ marginBottom: '1rem' }}>
                        <span style={{
                            ...
                            borderRadius: '4px',
                            fontWeight: 'bold',
                            background: isEnabled && timerState?.isRunning ? '#4CAF50' : '#666',
                            color: isEnabled && timerState?.isRunning ? 'white' : '#ccc'
                        }}>
                            {isEnabled && timerState?.isRunning ? '🔊 Audio Active' : '🔇 Audio Inactive'}
                        </span>
                    </div>
                    
                    <div style={{ margin: '1rem 0', color: '#ccc' }}>
                    ...
                    {timerState && timerState.isRunning && (
                        <div style={{
                            ...
                            <div style={{ marginBottom: '0.25rem' }}>Phase: {timerState.phase}</div>
                            <div style={{ marginBottom: '0.25rem' }}>Progress: {Math.round(timerState.progress * 100)}%</div>
